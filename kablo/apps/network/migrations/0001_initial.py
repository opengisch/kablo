    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('section', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='network.section')),
                ('tube', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='network.tube')),
            ],
        ),
        migrations.CreateModel(
            name='Cable',
